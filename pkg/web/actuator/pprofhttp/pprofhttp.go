...
func collectProfile(p *pprof.Profile) (*Profile, error) {
	var buf bytes.Buffer
...
// IndexHandler responds to a request for "/debug/pprof/" with an HTML page
// listing the available profiles.
func IndexHandler(w http.ResponseWriter, r *http.Request) {
	if name, found := strings.CutPrefix(r.URL.Path, "/actuator/pprof/"); found {
		if name != "" {
